...
def final_fast_phase_schedule(
    ...
    """Return a uniform fast phase that continues through the dwell segment."""
    ...
    phase_step = 2.0 * np.pi / (turn_frame_count - 1)
    return phase_step * np.arange(
        turn_frame_count + hold_frame_count,
        dtype=float,
    )
...
- Post-turn dwell: {metadata["display"]["chapter_1_final_post_turn_dwell_seconds"]:.2f} s
- Fast phase continues through dwell: {metadata["display"]["chapter_1_final_fast_phase_continues_through_dwell"]}
- Additional phase turns during dwell: {metadata["display"]["chapter_1_final_dwell_phase_turns"]:.3f}
...
- 36.5 s: continued fast-phase rotation during the Chapter 1 dwell.
...
- In-frame time label advances continuously beyond t=2 pi/f during the dwell: passed.
- Final right-panel background alpha and foreground hierarchy: passed.
- Uniform Chapter 1 fast phase before and throughout the dwell: passed.
- Fast phase continues rotating throughout the 5.0 s Chapter 1 dwell: passed.
    ...
    display_metadata.update(
        {
            ...
            "chapter_1_final_post_turn_dwell_seconds": (
            ...
            "chapter_1_final_post_turn_dwell_frame_count": (
                phase_hold_frame_count
            ),
            "chapter_1_final_fast_phase_continues_through_dwell": True,
            "chapter_1_final_dwell_phase_turns": dwell_phase_turns,
